...
using KTSF.Core.Object.Object.Product_;
using KTSF.Core.Object.PackingList_;
...
namespace KTSF.Persistence
{
    public class ObjectDbContext : DbContext
    {
        ...
        public ObjectDbContext(IHttpContextAccessor IHttpContextAccessor, AppDbContext appDbContext)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                // if (claim == null) claim = "DEBUG"; // Допустим, нет http-контекста, например, когда вы обновляете базу данных из PMC


            #if RELEASE

                int? userId = httpContext?.User?.Claims.GetUserId();
                int? companyId = httpContext?.User?.Claims.GetCompanyId();
                int? objectId = httpContext?.User?.Claims.GetObjectId();

                Company? company = _appDbContext.Companies.Where(c => c.UserId == userId && c.CompanyStatus == CompanyStatus.Active).Include(c => c.Objects.Where(obj => obj.Id == objectId)).FirstOrDefault();

                Object? @object = company.Objects?.FirstOrDefault();

                 optionsBuilder.UseMySQL(String.Format(ConnectionString, @object.DatabaseName));

            #else
                           optionsBuilder.UseMySQL(String.Format(ConnectionString, "111"));
            #endif
        ...
        private Employee[] GetEmployeesDefault()
        {
            ...
            return [new Employee()
            {
                ...
                ASetOfRulesId = 1,
                EmployeeStatusId = 3,
                JwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEifQ.GQm1j57RyZMHdwsolLnzhoB9A49mC0KusQBpHS9_-kQ",
                Name = "Иван",
                Surname = "Калмыков",
                ...
                new Employee()
                {
                    ...
                    ASetOfRulesId = 2,
                    EmployeeStatusId = 3,
                    JwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjIifQ.cbpuaPB0oVEkmkgFvfQUcaRb58xRn5zlClDroWd75JA",
                    Name = "Артур",
                    Surname = "Соколов",
                    Patronymic = "Игоревич",
                    PassportSeries = "1234",
                ...
                new Employee()
                {
                    ...
                    ASetOfRulesId = 3,
                    EmployeeStatusId = 3,
                    JwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjMifQ.n0AxopvGMqJUdvyuXVuBZOurMD2Tiah-EqFi-a-lR6E",
                    Name = "Александр",
                    Surname = "Трунин",
                ...
                new Employee()
                {
                    ...
                    ASetOfRulesId = 4,
                    EmployeeStatusId = 3,
                    JwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjQifQ.NiQnkH09RTP1QMiS9rbWLQ3iDJbZ2CV3RsBflk5QjXs",
                    Name = "Алексей",
                    Surname = "Федосов",
                ...
                new Employee()
                {
                    ...
                    ASetOfRulesId = 5,
                    EmployeeStatusId = 2,
                    JwtToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjUifQ.t9QlQfK-k6WS2yA2KlKgn0JRCQhDaz5Ujo8UBVTJWCM",
                    Name = "Ансар",
                    Surname = "Агадуллин",
        ...
        private Barcode[] GetBarcodesDefault()
        {
            ...
            return [
                   new Barcode()
                   {
                       ...
                       ProductId = 1,
                       Code = "barcode_1",
                       Type = KTSF.Core.Object.Product_.Type.Code128,
