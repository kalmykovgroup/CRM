        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            try
            {
               ...
               values(
                ...
                int AppointmentId2 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Менеджер по закупкам", Description = "" });
                int AppointmentId3 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Старший кассир", Description = "" });
                int AppointmentId4 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Кассир", Description = "" });
                int AppointmentId5 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Бугалтер", Description = "" });
                int AppointmentId6 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Охранник", Description = "" });
                int AppointmentId7 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Уборщик", Description = "" });
                int AppointmentId8 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Водитель", Description = "" });
                int AppointmentId9 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Грущик", Description = "" });
                int AppointmentId10 = db.ExecuteScalar<int>(sqlQuery, new Appointment() { Name = "Слесарь", Description = "" });

                sqlQuery = $@"insert into {GetTableName(typeof(ASetOfRules))}
                ({nameof(ASetOfRules.Name)}, 
                {nameof(ASetOfRules.Description)} )
               values(
                @{nameof(ASetOfRules.Name)}, 
                @{nameof(ASetOfRules.Description)}); select LAST_INSERT_ID();";


                int RulesId1 = db.ExecuteScalar<int>(sqlQuery, new ASetOfRules() { Name = "Администратор", Description = "" });
                int RulesId2 = db.ExecuteScalar<int>(sqlQuery, new ASetOfRules() { Name = "Старший кассир", Description = "" });
                int RulesId3 = db.ExecuteScalar<int>(sqlQuery, new ASetOfRules() { Name = "Менеджер по закупкам", Description = "" });
                int RulesId4 = db.ExecuteScalar<int>(sqlQuery, new ASetOfRules() { Name = "Кассир", Description = "" });
                int RulesId5 = db.ExecuteScalar<int>(sqlQuery, new ASetOfRules() { Name = "Кассир Евгений", Description = "Установленные дополнительные права доступа на изменение цены для товаров" });
                int RulesId6 = db.ExecuteScalar<int>(sqlQuery, new ASetOfRules() { Name = "Бугалтер", Description = "" });
            ...
            @{nameof(EmployeeStatus.Name)}); select LAST_INSERT_ID();";
                ...
                int employeeStatusId1 = db.ExecuteScalar<int>(sqlQuery, new EmployeeStatus() { Name = "Не трудоустроен" });
                int employeeStatusId2 = db.ExecuteScalar<int>(sqlQuery, new EmployeeStatus() { Name = "Трудоустроен" });
                db.ExecuteScalar<int>(sqlQuery, new EmployeeStatus() { Name = "Временный трудовой договор" });
                int employeeStatusId3 = db.ExecuteScalar<int>(sqlQuery, new EmployeeStatus() { Name = "Уволен" });
               ...
               values (
                ...
                Employee employee1 = new Employee()
                {
                    ...
                    ASetOfRulesId = RulesId1,
                    EmployeeStatusId = employeeStatusId1,
                ...
                Employee employee2 = new Employee()
                {
                    ...
                    ASetOfRulesId = RulesId2,
                    EmployeeStatusId = employeeStatusId2,
                ...
                Employee employee3 = new Employee()
                {
                    ...
                    ASetOfRulesId = RulesId3,
                    EmployeeStatusId = employeeStatusId3,
            ...
            ( 
             {nameof(ProductInformation.ProductId)},
            ...
            values( 
             ...
             @{nameof(Article.Name)}); select LAST_INSERT_ID();";
                ...
                db.ExecuteScalar<int>(sqlQueryBarcode, new Barcode()
                {
                    ProductId = productId,
                    Code = "barcode test",
